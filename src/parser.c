...
enum {
  ...
  sym__relationship_body_block = 53,
...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__relationship_body_block, 2),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__relationship_body_block, 2),
  ...
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__relationship_body_block, 3),
  [142] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__relationship_body_block, 3),
